cmd_drivers/mstar/spinand/drvSPINAND_dev.o := arm-linux-gnueabihf-gcc -Wp,-MD,drivers/mstar/spinand/.drvSPINAND_dev.o.d  -nostdinc -isystem /home/industio/ssd20x/gcc-arm-8.2-2018.08-x86_64-arm-linux-gnueabihf/bin/../lib/gcc/arm-linux-gnueabihf/8.2.1/include -Iinclude  -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__ -DCONFIG_SYS_TEXT_BASE=0x23E00000 -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -Os -fno-stack-protector -g -fstack-usage -Wno-format-nonliteral -Werror=date-time -I./drivers/mstar/spinand/inc/common -I./drivers/mstar/spinand/inc/config -I./drivers/mstar/spinand/inc -I./drivers/mstar/spinand/inc/config/infinity2m -D__ARM__ -marm -mno-thumb-interwork -mabi=aapcs-linux -mword-relocations -march=armv7-a -mno-unaligned-access -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -mfloat-abi=soft -pipe    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(drvSPINAND_dev)"  -D"KBUILD_MODNAME=KBUILD_STR(spi_nand)" -c -o drivers/mstar/spinand/drvSPINAND_dev.o drivers/mstar/spinand/drvSPINAND_dev.c

source_drivers/mstar/spinand/drvSPINAND_dev.o := drivers/mstar/spinand/drvSPINAND_dev.c

deps_drivers/mstar/spinand/drvSPINAND_dev.o := \
  ...
  drivers/mstar/spinand/inc/common/../../inc/common/drvSPINAND.h \
  drivers/mstar/spinand/inc/common/../../inc/common/drvSPINAND_common.h \
  drivers/mstar/spinand/inc/common/../../inc/common/../MsTypes.h \
  drivers/mstar/spinand/inc/common/../../inc/common/../config/drvSPINAND_config.h \
    $(wildcard include/config/h//.h) \
  drivers/mstar/spinand/inc/common/../../inc/common/../config/../MsTypes.h \
  ...
  drivers/mstar/spinand/inc/common/../../inc/common/spinand.h \
  drivers/mstar/spinand/inc/common/../../inc/common/drvSPINAND.h \

drivers/mstar/spinand/drvSPINAND_dev.o: $(deps_drivers/mstar/spinand/drvSPINAND_dev.o)
