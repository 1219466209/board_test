cmd_drivers/mstar/uart/infinity2m/uart_padmux.o := arm-linux-gnueabihf-gcc -Wp,-MD,drivers/mstar/uart/infinity2m/.uart_padmux.o.d  -nostdinc -isystem /home/industio/ssd20x/gcc-arm-8.2-2018.08-x86_64-arm-linux-gnueabihf/bin/../lib/gcc/arm-linux-gnueabihf/8.2.1/include -Iinclude  -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__ -DCONFIG_SYS_TEXT_BASE=0x23E00000 -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -Os -fno-stack-protector -g -fstack-usage -Wno-format-nonliteral -Werror=date-time -I./drivers/mstar/uart/infinity2m -I./drivers/mstar/uart -D__ARM__ -marm -mno-thumb-interwork -mabi=aapcs-linux -mword-relocations -march=armv7-a -mno-unaligned-access -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -mfloat-abi=soft -pipe    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(uart_padmux)"  -D"KBUILD_MODNAME=KBUILD_STR(uart_padmux)" -c -o drivers/mstar/uart/infinity2m/uart_padmux.o drivers/mstar/uart/infinity2m/uart_padmux.c

source_drivers/mstar/uart/infinity2m/uart_padmux.o := drivers/mstar/uart/infinity2m/uart_padmux.c

deps_drivers/mstar/uart/infinity2m/uart_padmux.o := \
    $(wildcard include/config/uart1/pad.h) \
    $(wildcard include/config/uart2/pad.h) \
    $(wildcard include/config/uart3/pad.h) \
  include/common.h \
  ...
  drivers/mstar/uart/ms_serial.h \
  include/serial.h \
...
drivers/mstar/uart/infinity2m/uart_padmux.o: $(deps_drivers/mstar/uart/infinity2m/uart_padmux.o)
