cmd_drivers/mstar/panel/./drv/pnl/src/drv_pnl_ctx.o := arm-linux-gnueabihf-gcc -Wp,-MD,drivers/mstar/panel/./drv/pnl/src/.drv_pnl_ctx.o.d  -nostdinc -isystem /home/industio/ssd20x/gcc-arm-8.2-2018.08-x86_64-arm-linux-gnueabihf/bin/../lib/gcc/arm-linux-gnueabihf/8.2.1/include -Iinclude  -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__ -DCONFIG_SYS_TEXT_BASE=0x23E00000 -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -Os -fno-stack-protector -g -fstack-usage -Wno-format-nonliteral -Werror=date-time -I./drivers/mstar/panel/drv/pnl/inc -I./drivers/mstar/panel/drv/pnl/inc/uboot -I./drivers/mstar/panel/drv/pnl/pub -I./drivers/mstar/panel/drv/mipnl/pub -I./drivers/mstar/panel/hal/infinity2m/inc -I./drivers/mstar/panel/hal/infinity2m/pub -I./drivers/mstar/panel/hal/pub -I./drivers/mstar/panel/../common -D__ARM__ -marm -mno-thumb-interwork -mabi=aapcs-linux -mword-relocations -march=armv7-a -mno-unaligned-access -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -mfloat-abi=soft -pipe    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(drv_pnl_ctx)"  -D"KBUILD_MODNAME=KBUILD_STR(drv_pnl_ctx)" -c -o drivers/mstar/panel/./drv/pnl/src/drv_pnl_ctx.o drivers/mstar/panel/./drv/pnl/src/drv_pnl_ctx.c

source_drivers/mstar/panel/./drv/pnl/src/drv_pnl_ctx.o := drivers/mstar/panel/./drv/pnl/src/drv_pnl_ctx.c

deps_drivers/mstar/panel/./drv/pnl/src/drv_pnl_ctx.o := \
...
drivers/mstar/panel/./drv/pnl/src/drv_pnl_ctx.o: $(deps_drivers/mstar/panel/./drv/pnl/src/drv_pnl_ctx.o)
