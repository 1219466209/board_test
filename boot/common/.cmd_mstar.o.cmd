cmd_common/cmd_mstar.o := arm-linux-gnueabihf-gcc -Wp,-MD,common/.cmd_mstar.o.d  -nostdinc -isystem /home/industio/ssd20x/gcc-arm-8.2-2018.08-x86_64-arm-linux-gnueabihf/bin/../lib/gcc/arm-linux-gnueabihf/8.2.1/include -Iinclude  -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__ -DCONFIG_SYS_TEXT_BASE=0x23E00000 -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -Os -fno-stack-protector -g -fstack-usage -Wno-format-nonliteral -Werror=date-time -D__ARM__ -marm -mno-thumb-interwork -mabi=aapcs-linux -mword-relocations -march=armv7-a -mno-unaligned-access -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -mfloat-abi=soft -pipe -I./drivers/mstar/spinand/inc/config/"infinity2m" -I.    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(cmd_mstar)"  -D"KBUILD_MODNAME=KBUILD_STR(cmd_mstar)" -c -o common/cmd_mstar.o common/cmd_mstar.c

source_common/cmd_mstar.o := common/cmd_mstar.c

deps_common/cmd_mstar.o := \
    ...
    $(wildcard include/config/sstar/upgrade/ui.h) \
    ...
    $(wildcard include/config/ms/aesdma.h) \
  include/common.h \
  ...
  include/../drivers/mstar/aesdma/hal/halAESDMA.h \
  ...
  common/../drivers/mstar/spinand/inc/common/spinand.h \
  common/../drivers/mstar/spinand/inc/common/drvSPINAND.h \
  common/../drivers/mstar/spinand/inc/common/drvSPINAND_common.h \
  common/../drivers/mstar/spinand/inc/common/../MsTypes.h \
  common/../drivers/mstar/spinand/inc/common/../config/drvSPINAND_config.h \
    $(wildcard include/config/h//.h) \
  common/../drivers/mstar/spinand/inc/common/../config/../MsTypes.h \
...
common/cmd_mstar.o: $(deps_common/cmd_mstar.o)
