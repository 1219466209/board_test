cmd_common/MsSysUtility.o := arm-linux-gnueabihf-gcc -Wp,-MD,common/.MsSysUtility.o.d  -nostdinc -isystem /home/industio/ssd20x/gcc-arm-8.2-2018.08-x86_64-arm-linux-gnueabihf/bin/../lib/gcc/arm-linux-gnueabihf/8.2.1/include -Iinclude  -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__ -DCONFIG_SYS_TEXT_BASE=0x23E00000 -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -Os -fno-stack-protector -g -fstack-usage -Wno-format-nonliteral -Werror=date-time -D__ARM__ -marm -mno-thumb-interwork -mabi=aapcs-linux -mword-relocations -march=armv7-a -mno-unaligned-access -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -mfloat-abi=soft -pipe    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(MsSysUtility)"  -D"KBUILD_MODNAME=KBUILD_STR(MsSysUtility)" -c -o common/MsSysUtility.o common/MsSysUtility.c

source_common/MsSysUtility.o := common/MsSysUtility.c

deps_common/MsSysUtility.o := \
    $(wildcard include/config/ms/gpio.h) \
  include/common.h \
  ...
  include/MsTypes.h \
  common/../drivers/mstar/gpio/drvGPIO.h \
  common/../arch/arm/include/asm/arch-infinity/mach/io.h \
  common/../arch/arm/include/asm/arch-infinity/mach/platform.h \
  arch/arm/include/asm/arch/mach/ms_types.h \

common/MsSysUtility.o: $(deps_common/MsSysUtility.o)
