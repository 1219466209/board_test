cmd_common/cmd_customer_init.o := arm-linux-gnueabihf-gcc -Wp,-MD,common/.cmd_customer_init.o.d  -nostdinc -isystem /home/industio/ssd20x/gcc-arm-8.2-2018.08-x86_64-arm-linux-gnueabihf/bin/../lib/gcc/arm-linux-gnueabihf/8.2.1/include -Iinclude  -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__ -DCONFIG_SYS_TEXT_BASE=0x23E00000 -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -Os -fno-stack-protector -g -fstack-usage -Wno-format-nonliteral -Werror=date-time -D__ARM__ -marm -mno-thumb-interwork -mabi=aapcs-linux -mword-relocations -march=armv7-a -mno-unaligned-access -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -mfloat-abi=soft -pipe    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(cmd_customer_init)"  -D"KBUILD_MODNAME=KBUILD_STR(cmd_customer_init)" -c -o common/cmd_customer_init.o common/cmd_customer_init.c

source_common/cmd_customer_init.o := common/cmd_customer_init.c

deps_common/cmd_customer_init.o := \
    $(wildcard include/config/ms/usb.h) \
    $(wildcard include/config/cmd/keypad/force/upgrade.h) \
  ...
  common/../drivers/mstar/gpio/infinity2m/padmux.h \
  common/../drivers/mstar/sar/sar.h \

common/cmd_customer_init.o: $(deps_common/cmd_customer_init.o)
